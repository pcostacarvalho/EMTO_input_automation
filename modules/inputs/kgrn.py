...
def create_kgrn_input_afm(path, id_namev, id_namer, SWS, k):
    """
...
KMSH...= S IBZ..=  5 NKX..= {k:>2} NKY..= {k:>2} NKZ..= {k:>2} FBZ..=  N
...
Fe     4   3   1   1  1.000000  0.750 1.100  0.0000  0.0000  N  -2.0000
**********************************************************************
...
def create_kgrn_input_afm_dlm(path, id_namev, id_namer, SWS, k, PERC):
    """
    Create a KGRN (self-consistent KKR) input file for EMTO.
...
******************************SS-screeining*|***Magnetic structure ***
Symb  IQ  IT ITA NRM  CONC      a_scr b_scr |Teta    Phi    FXM  m(split)
Pt     1   1   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   0.4000
Pt     2   1   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   0.4000
Fe     3   2   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   2.0000
Fe     4   3   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -2.0000
Pt     1   1   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -0.4000
Pt     2   1   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -0.4000
Fe     3   2   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -2.0000
Fe     4   3   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   2.0000
**********************************************************************
Spin-spiral wave vector:
qx....= 0.000000 qy....= 0.000000 qz....= 0.000000
**********************************************************************
...
def create_kgrn_input_fm(path, id_namev, id_namer, SWS, k):
    """
    Create a KGRN (self-consistent KKR) input file for EMTO.
...
def create_kgrn_input_pm(path, id_namev, id_namer, SWS, k, PERC):
    """
    Create a KGRN (self-consistent KKR) input file for EMTO.
...
Pt     2   1   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   0.4000
Fe     3   2   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   2.0000
Fe     4   2   1   1  {PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N   2.0000
Pt     1   1   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -0.4000
Pt     2   1   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -0.4000
Fe     3   2   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -2.0000
Fe     4   2   2   1  {1-PERC:>8.6f}  0.750 1.100  0.0000  0.0000  N  -2.0000
**********************************************************************
Spin-spiral wave vector:
qx....= 0.000000 qy....= 0.000000 qz....= 0.000000
**********************************************************************
